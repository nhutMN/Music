...
import PictureInPictureBottomRight from './icon/PictureInPictureBottomRight.vue';
import iconPlay from './icon/iconPlay.vue';
import iconPause from './icon/iconPause.vue';
import SkipBackward from './icon/SkipBackward.vue';
    ...
    >
        <div class="flex items-center w-1/4">
            <div class="flex items-center ml-4">
                <img class="rounded-sm shadow-2xl" width="55" :src="currentArtist.album">
                <div class="ml-4">
            ...
            <div class="flex items-center ml-8">
                ...
                <component :is="PictureInPictureBottomRight" class="w-5 h-5" />
        ...
        <div class="max-w-[35%] mx-auto w-2/4 mb-3">
            <div class="flex-col items-center justify-center">
                <div class="buttons flex items-center justify-center h-[30px]">
                    <button class="mx-2">
                        <component :is="SkipBackward" @click="useSong.prevSong(currentTrack)" class="w-5 h-5" />
                        <!-- <SkipBackward fillColor="#FFFFFF" :size="25" @click="useSong.prevSong(currentTrack)"/> -->
                    </button>
                    <button class="p-1 mx-3" @click="useSong.playOrPauseThisSong(currentArtist, currentTrack)">
                    ...
                    <button class="mx-2">
                        <component :is="SkipForward" @click="useSong.nextSong(currentTrack)" class="w-5 h-5" />
